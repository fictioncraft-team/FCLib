...
public class RenderingHelper {
    public static void renderItemStackInGui(MatrixStack matrixStack, int xPosition, int yPosition, @Nullable ItemStack stackToRender, boolean renderOverlays) {
        if (stackToRender != null) {
            ...
            renderItemModelIntoGUI(stackToRender, xPosition, yPosition, 64, 64, 64);
            if (renderOverlays) {
                itemRenderer.renderItemOverlayIntoGUI(font, stackToRender, xPosition, yPosition, (String) null);
            }
